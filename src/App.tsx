          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-5 relative z-10">
              <div className="p-4 bg-white/10 rounded-2xl border border-white/20 shadow-inner shrink-0">
                <PartyPopper className="w-8 h-8 text-cscm-gold animate-bounce" />
              </div>
              <div className="space-y-2 text-left flex-1">
                <h2 className="text-xl md:text-2xl font-bold tracking-tight flex items-center gap-2 text-white">
                  <span>Félicitations et bienvenue, {userName} !</span>
                  <Sparkles className="w-5 h-5 text-cscm-gold fill-cscm-gold shrink-0" />
                </h2>
                <p className="text-xs md:text-sm text-white/85 leading-relaxed font-medium max-w-4xl">
                  Votre inscription a été finalisée avec succès et votre compte est désormais actif. Vous avez été connecté automatiquement.
                  En tant que membre de la <strong>Chambre Sénégalaise de Commerce au Maroc</strong>, vous disposez d'un accès complet pour piloter les entreprises adhérentes, suivre les cotisations et gérer les profils utilisateurs.
                </p>
                <div className="pt-2 flex flex-wrap gap-3">
                  <button
                    type="button"
                    onClick={() => setShowWelcome(false)}
                    className="bg-white hover:bg-cscm-green-soft text-cscm-green px-5 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer shadow-md flex items-center gap-1.5"
                  >
                  ...
                  <Link
                    to="/enterprises/add"
                    className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-5 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5"
                  >
