...
import { getStoredUsers, isLocalEnvironment } from '../utils/userStorage';
...
export const Login: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (matchedUser) {
      ...
      const expectedPassword = localMode ? '12345' : matchedUser.password;
      if (expectedPassword && expectedPassword !== password) {
        setError(localMode ? 'Mot de passe incorrect. En local, utilisez 12345.' : 'Mot de passe incorrect pour cet utilisateur.');
        return;
      }
        ...
        <div className="auth-form-panel">
          <div className="max-w-sm mx-auto w-full space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" id="login-submit-btn" className="auth-submit-btn">
                Se connecter
              </button>
            </form>
